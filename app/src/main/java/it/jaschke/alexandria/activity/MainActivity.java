...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, Callback, AddBook.OnScanClickListener {
    ...
    public static final int BARCODE_REQUEST = 100;
    ...
    public void launchBarcode() {
        startActivityForResult(new Intent(this, BarcodeCaptureActivity.class), BARCODE_REQUEST);
    }
